...
export default function FacturasView() {
  ...
  const handleFacturaPress = async (factura) => {
    ...
    try {
      ...
      // Usar los datos del usuario que vienen en la factura
        ...
        >
          <View style={styles.amortModalOverlay}>
            <View style={[
              ...
              { 
                width: isDesktop ? '50%' : isTablet ? '70%' : '92%',
                maxWidth: 700
              }
            ]}>
              <Text style={[
                  ...
                  <View style={styles.amortTable}>
                    ...
                    {amortizacion.map((fila, idx) => (
                      <View key={idx} style={[
                        ...
                        idx % 2 === 0 && styles.amortTableRowEven
                      ]}>
